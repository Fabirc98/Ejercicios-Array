...
const programmingBooks = [
  ...
  if (programmingBooks.includes(userInput)) {
    alert("El libro se encuentra en la lista de libros de programación.");
  } else {
    alert("El libro no se encuentra en la lista de libros de programación.");
  }